...
```text
python -m pytest test_er64_quality_scoping_a.py -q
python -m py_compile run_er64_quality_scoping_a.py
python run_er64_quality_scoping_a.py --smoke --output-dir <synthetic-output>
```

Real Phase 2 execution is intentionally explicit:

```text
python run_er64_quality_scoping_a.py --full --confirm-quality-scoping-a --output-dir <real-output>
```
...
The disjoint 60-document validation is evaluated only at update 2000 and is
observational; it never gates or changes primary classification.
