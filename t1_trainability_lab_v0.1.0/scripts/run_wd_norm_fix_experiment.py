"""Run the 10-run optimizer/readout diagnostic experiment."""
...
REASON = "Diagnostic: test weight-decay-exclusion + final-norm fix from Phase A findings"
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "campaign" / "wd_norm_fix")
